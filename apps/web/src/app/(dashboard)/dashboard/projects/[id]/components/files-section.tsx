...
export function FilesSection({
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const url = `/files/upload?projectId=${projectId}`;
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        {!isArchived && (
          <label className="flex items-center gap-2 px-3 py-1.5 bg-[var(--primary)] text-white rounded-lg text-sm hover:opacity-90 cursor-pointer">
            <Upload size={14} />
